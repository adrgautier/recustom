...
exports.default = HOCFactory_1.default(function (componentName, customPropertiesMapper, stateClassesMappers) { return function (Component) { var _a; return _a = (function (_super) {
        ...
        Object.defineProperty(Style.prototype, "className", {
            get: function () {
                ...
                if (typeof bindState === "undefined") {
                    return classNames(componentName, __assign({}, stateClassesMappers.reduce(function (classes, mapper) { return (__assign({}, classes, getClasses_1.default(mapper, props, state))); }, {})), descendingClassName);
                }
