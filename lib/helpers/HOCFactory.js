...
exports.default = (function (hoc) { return function () {
    ...
    return function (Component) {
        if (typeof mappers[0] === "string") {
            return hoc(mappers[0], mappers[1], getStateClassesMappers_1.default(Component).concat([
                mappers[2]
            ]))(Component);
        }
        return hoc(getComponentName_1.default(Component), mappers[0], getStateClassesMappers_1.default(Component).concat([
            mappers[1]
        ]))(Component);
    };
}; });
